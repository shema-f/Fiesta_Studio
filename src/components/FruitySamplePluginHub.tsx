...
const HUB_ITEMS: HubItem[] = [
  ...
  // --- PC VST GENERATORS & PLUGINS ---
  {
    id: 'vst_3xosc',
    name: '3xOSC Multi-Waveform Synth',
    category: 'plugins',
    subCategory: 'FL Generators',
    type: 'synth',
    isPlugin: true,
    instrumentType: 'synth',
    description: 'FL Studio classic 3-oscillator subtractive synthesizer with fat detune and filter envelope',
    license: 'Virtual FL VST Engine',
    tags: ['3xosc', 'synth', 'subtractive', 'vst', 'generator', 'leads'],
  },
  {
    id: 'vst_sytrus',
    ...
    isPlugin: true,
    instrumentType: 'synth',
    description: 'Advanced 6-operator frequency modulation & subtractive synth for bells, plucks & pads',
    license: 'Virtual FL VST Engine',
    tags: ['sytrus', 'fm', 'synth', 'vst', 'generator', 'metallic'],
  },
  {
    id: 'vst_harmless',
    ...
    isPlugin: true,
    instrumentType: 'synth',
    description: 'Additive timbre generator with warm resonant analog filters and unison chorus',
    license: 'Virtual FL VST Engine',
    tags: ['harmless', 'additive', 'vst', 'warm', 'filter'],
  },
  {
    id: 'vst_flex',
    name: 'FLEX Studio Multi-Instrument',
    category: 'plugins',
    subCategory: 'PC VST Instruments',
    type: 'keys',
    isPlugin: true,
    instrumentType: 'keys',
    description: 'High-definition sampled instruments, guitars, electronic keys and synth strings',
    license: 'Virtual FL VST Engine',
    tags: ['flex', 'romler', 'keys', 'guitars', 'strings', 'vst'],
  },
  {
    id: 'vst_minisynth',
    ...
    isPlugin: true,
    instrumentType: 'synth',
    description: 'Punchy dual-oscillator analog synth with portamento glide and distortion drive',
    license: 'Virtual FL VST Engine',
    tags: ['minisynth', 'analog', 'lead', 'mono', 'vst'],
  },
  {
    id: 'vst_soundfont',
    name: 'PC SoundFont Player (.sf2)',
    category: 'plugins',
    subCategory: 'PC VST Sampler',
    type: 'piano',
    isPlugin: true,
    instrumentType: 'piano',
    description: 'Direct bridge to PC SoundFont files, multi-sampled instruments, and General MIDI banks',
    license: 'Virtual FL VST Engine',
    tags: ['soundfont', 'sf2', 'sampler', 'pc', 'bank'],
  },
];
      ...
      <div className="w-full max-w-4xl max-h-[85vh] bg-[#141824] border border-[#2b3548] rounded-2xl shadow-2xl flex flex-col overflow-hidden">
        ...
        <div className="p-4 bg-[#161c2b] border-b border-[#242e42] flex flex-wrap gap-3 items-center justify-between">
          ...
          <div className="flex items-center gap-1 overflow-x-auto scrollbar-none">
            {[
              { id: 'all', label: 'All Sounds & VSTs' },
              { id: 'plugins', label: '💻 PC VSTs & Synths' },
              { id: 'splice_drums', label: '🥁 Drum Samples' },
